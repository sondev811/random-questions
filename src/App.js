...
export const questionList = [
  ...
  },
  {
    ...
    answer: [
      ...
      "var có tính chất hoisting, let và const không có tính chất hoisting. VD:",
      `console.log(a); // Không bị lỗi kết quả là undefined
       var a = 1;

       console.log(a); // bị lỗi
       let a = 1;
      `,
      "trong cùng một scope thì var có thể khai báo lại, let và const thì không thể khai báo lại(nhưng ngoài phạm vị thì được, vd dưới)",
      `var greeting = 'hi';
       if (true) {
        var greeting = 'hello';
       }
  ...
  },
  {
    ...
    answer: [
      "Global scope: biến toàn cục, biến nằm ngoài tất cả các funtion",
      "Block scope chỉ có giá trị trong dấu ngoặc nhọn",
    ],
  },
  {
  ...
  },
  {
    ...
    answer: [
      "Closure là 1 hàm có khả năng nhớ nơi nó được tạo ra và có thể truy cập tới biến ở 3 phạm vi: toàn cục, biến bên trong hàm closure và biến của hàm chứa nó, dù cho hàm đó đã return",
  ...
  return (
    <div className="App">
      {questions.map((element, index) => {
        return (
          <div key={index}>
            <h3 onClick={() => showResult(index)}>{element.question}</h3>
